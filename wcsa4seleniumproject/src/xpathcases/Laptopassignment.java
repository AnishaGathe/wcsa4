...
public class Laptopassignment {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		String priceoflaptop = driver.findElement(By.xpath("//div[.='HP Victus Intel Core i7 12th Gen - (8 GB/512 GB SSD/Windows 11 Home/4 GB Graphics/NVIDIA GeForce RTX 3...']/ancestor::div[@class='_3pLy-c row']/descendant::div[@class='_30jeq3 _1_WHN1']")).getText();
